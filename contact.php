  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Contacto</h2>
          </div>
          <div class="col-md-12">
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h2 class="text-black mb-4">Oficina</h2>
          </div>
          <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="block-7">
              <h3 class="footer-heading mb-4">Sobre <strong class="text-primary">Farma</strong>T</h3>
              <p>En nuestra farmacia en línea, nos dedicamos a ofrecerte productos farmacéuticos de alta calidad y servicios 
                confiables para cuidar de tu salud y bienestar. Con un amplio catálogo de medicamentos, productos de 
                cuidado personal y atención al cliente excepcional, estamos aquí para ser tu aliado en el camino hacia una vida más saludable..</p>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <p>
              ...
              Copyright &copy;
              <script>document.write(new Date().getFullYear());</script> Todos los derechos reservados por  <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"
